...
const Acquisitions = () => {
  ...
  return (
    <div className="animate-fade-in relative min-h-screen pb-24">
      ...
      <div className="hidden md:block sticky top-0 z-40 -mx-4 md:-mx-8 -mt-5 md:-mt-8 border-b border-border-subtle/30 bg-bg-base/95 px-4 py-4 shadow-sm backdrop-blur-md md:px-8 mb-6">
